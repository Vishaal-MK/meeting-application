...
//this module in not cross plateform


//bug in get function and set function
//opening files in every function call that slow down performance
// buffer size is too low for holding large file
