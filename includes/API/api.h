...
public:
    static nlohmann::json get(std::string url, nlohmann::json http_header = 0);

    static nlohmann::json post(std::string url, nlohmann::json data = 0, nlohmann::json http_header = 0);
    static nlohmann::json post(std::string url, std::string data, nlohmann::json http_header);
        static nlohmann::json put(std::string url, std::string data, nlohmann::json http_header);
...
nlohmann::json fetch(std::string url, std::string method, nlohmann::json data, nlohmann::json headers)
{
